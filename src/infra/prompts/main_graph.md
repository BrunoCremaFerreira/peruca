...
4. Se houver mais de uma intenção (por exemplo: “Acenda a luz da sala e adicione leite na lista”), retorne **todas** as categorias em uma lista Python.
5. Não faça suposições: classifique **apenas com base na intenção presente** na mensagem, não em possíveis contextos futuros.

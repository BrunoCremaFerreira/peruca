...
- “music” → quando o usuário quer **controlar a reprodução de música**: tocar, pausar, pular faixa, ajustar volume do player de música, ou perguntar o que está tocando. Use o contexto de música acima para desambiguar comandos curtos como “próxima”, “pausa”, “volume” quando há música tocando.
...
7. **Desambiguação de música**: quando o contexto indica que há música tocando (“Sim, há música tocando no momento.”), comandos curtos como “próxima”, “pausa”, “para”, “aumenta o volume”, “o que está tocando?” devem ser classificados como `[“music”]`.
